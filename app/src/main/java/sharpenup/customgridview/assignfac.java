...
//	int flag,flag_btn_click;
	...
	submit.setOnClickListener(new View.OnClickListener() {
		...
		if (universalChecker()){
			 ...
			 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(assignfac.this);
				builder.setMessage("Are you sure you want register this student?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(assignfac.this);
		   ...
		   private OnItemSelectedListener itemSelectedListener = new OnItemSelectedListener() {
		        ...
		        public void onItemSelected(AdapterView<?> arg0, View arg1, int position,
		        	...
		        	new subject().execute();
		        		...
		        		{Toast.makeText(assignfac.this, "Please select subject... ", 1).show();
		        		}
