...
//	int flag,flag_btn_click;
	...
	submit.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			builder.setMessage("Are you sure you want to mark attendance ?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(AttendanceActivity.this);
