...
//	int flag,flag_btn_click;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		date_pend_up = (TextView) findViewById(R.id.pdh);
		date_pend_down = (TextView) findViewById(R.id.pdl);
	    ...
	    spinner_fac = (Spinner) findViewById(R.id.faculty);
	...
	categories_faculty .add("SELECT FACULTY");
        ...
        spinner_center = (Spinner) findViewById(R.id.cen);
	...
	categories_center .add("DDN");
		...
		spinner_batch = (Spinner) findViewById(R.id.bat);
		...
		categories_batch .add("C");
	      ...
	      //  spinner_class = (Spinner) findViewById(R.id.center);
	        ...
	        spinner_class = (Spinner) findViewById(R.id.mycl);
	...
	submit = (Button)findViewById(R.id.sub_cal);
	...
	submit.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
				 ...
				 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
					...
					builder.setMessage("Are you sure you want to view time table?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class studentsview extends AsyncTask<String, Void, String> {
    	JSONObject json;
    	private ProgressDialog dialog = new ProgressDialog(view.this);
  	...
  	try {
  		...
  		ArrayList<String> arrayList7 = new ArrayList<String>();
			     ...
			     new UniversalTableLayout(dataContainer, view.this);
			       }
			       else{Toast.makeText(view.this, "Data Empty,there might be no class scheduled these days", Toast.LENGTH_SHORT).show();}
			        
  	}
  	catch (Exception e) 
  	{
			e.printStackTrace();
			Toast.makeText(view.this, e.getMessage(), Toast.LENGTH_SHORT).show();
		} 
...
*/
		...
		protected void setlist() {
		        ...
		        dialogReg = new Dialog(view.this);
		   ...
		   private void viewall() {
			   ...
			   ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(view.this, android.R.layout.simple_list_item_checked, categories_code);
