...
public class marks_assign  extends Activity implements OnItemClickListener{
...
//	int flag,flag_btn_click;
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		 pref = new PrefManager(marks_assign.this);
	...
	submit.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			 ...
			 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(marks_assign.this);
				builder.setMessage("Are you sure you want to assign marks ?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(marks_assign.this);
        ...
        {  			
        	try {
      		...
      		ArrayList<String> arrayList7 = new ArrayList<String>();
    			   ...
    			   if(crashPreventer==1){  
    				   crashPreventer=0;
    			     Intent i = new Intent(marks_assign.this,marksfill.class); 
    			     b.putString("name_roll", number);
    			     i.putExtras(b);

    			     startActivity(i);}
    			   else{
    					Toast.makeText(marks_assign.this, "Data empty!!!", Toast.LENGTH_SHORT).show();
    				}
      	...
      	{
    			e.printStackTrace();
				Toast.makeText(marks_assign.this, e.getMessage(), Toast.LENGTH_SHORT).show();
...
*/
		...
		protected void setlist() {
		        ...
		        dialogReg = new Dialog(marks_assign.this);
		   ...
		   private void viewall() {
			    ...
			    dataAdapter = new ArrayAdapter<String>(marks_assign.this, android.R.layout.simple_list_item_checked, categories_code);
