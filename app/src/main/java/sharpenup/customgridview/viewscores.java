...
import sharpenup.androidbegin.viewpagertutorial.Main;
import sharpenup.androidbegin.viewpagertutorial.view_atten;
...
//	int flag,flag_btn_click;
	...
	submit.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(viewscores.this);
				builder.setMessage("Are you sure you want to view scores?").setPositiveButton("Yes", dialogClickListener)
	...
	students.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			else 	Toast.makeText(viewscores.this, "Please Select all fields!!!", Toast.LENGTH_SHORT).show();
	...
	public boolean universalChecker(){
	 ...
	 private class percentile extends AsyncTask<String, Void, String> {
	    	...
	    	private ProgressDialog dialog = new ProgressDialog(viewscores.this);
    			       ...
    			       per_date.add(json.getString("DATE"));
    			        	if(s.contains("Roll Number ="+ roll_identity)){
					          ...
					          double  per_get = Double.parseDouble(get.trim());
					            ...
					            if(per_get >= item)
					            {
					            	per_absent.add("Hurray!! Student has passed the cut-off and the cut-off is " + item);
					            }
					            else{
					            	
					            		per_absent.add(" :( Student has not passed the cut-off and the cut-off is " + item);
    			        ...
    			        if(crashPreventer==1){
    			        	...
    			        	crashPreventer=0;
    			        Intent i = new Intent(viewscores.this,view_scores.class); 
    				     i.putExtras(b);
