...
//	int flag,flag_btn_click;
		...
		public void onClick(View v) {
			...
			if (universalChecker()){
				 ...
				 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
					...
					builder.setMessage("Are you sure you want to view this test shedule?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class studentsview extends AsyncTask<String, Void, String> {
    	JSONObject json;
    	private ProgressDialog dialog = new ProgressDialog(testview.this);
