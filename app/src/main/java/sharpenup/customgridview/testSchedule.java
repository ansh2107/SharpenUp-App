...
import sharpenup.worksheet.TeacherSubmission;
...
int myyear;
		...
		public void onClick(View v) {
			...
			if (universalChecker()){
				 ...
				 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(testSchedule.this);
					builder.setMessage("Are you sure you want to schedule this test?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(testSchedule.this);
      ...
      try {
  			...
  			Toast.makeText(testSchedule.this, "This test is already scheduled.", Toast.LENGTH_SHORT).show();
  			else
  				Toast.makeText(testSchedule.this, "Successfully scheduled.", Toast.LENGTH_SHORT).show();
  		} catch (Exception e) 
    	{
  			e.printStackTrace();
  			Toast.makeText(testSchedule.this, "Internet connection error!!!", Toast.LENGTH_SHORT).show();
  		} 
       }
