...
public class StudAtten  extends Activity{
	int crashPreventer;
...
//	int flag,flag_btn_click;
		...
		public void onClick(View v) {
			...
			if (universalChecker()){
				 ...
				 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(StudAtten.this);
					builder.setMessage("Are you sure you want to view this students' attendance?").setPositiveButton("Yes", dialogClickListener)
					    .setNegativeButton("No", dialogClickListener).show();}
			else{
				Toast.makeText(StudAtten.this, "Please Select all fields!!!", Toast.LENGTH_SHORT).show();
			}
	...
	students.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			else Toast.makeText(StudAtten.this, "Please Select all fields!!!", Toast.LENGTH_SHORT).show();
	...
	protected void executeCodeOfSubmit(){
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(StudAtten.this);
        ...
        {  			
        	try {
    			...
    			//Toast.makeText(MainActivity.this, (CharSequence) json, 1).show();
    				 ...
    				 JSONArray account= json.getJSONArray("pendings");
    			        ...
    			        String fac= json.getString("FACULTY");
    			       ...
    			       if(s.contains(present)){
		        		...
		        		if(p.contains(present)){
		        			per_present.add("PRESENT");
		        		
		        		}
		        		
		        		else	if(a.contains(present)){
		        			
		        			per_present.add("ABSENT");
		        			
		        		}
		        		
		        		else	if(l.contains(present)){
    		        	...
    		        	dataContainer.add(faculty.toArray( new String[faculty.size()] ));
		        ...
		        if(crashPreventer==1){
		        	crashPreventer=0;
		        	new UniversalTableLayout(dataContainer, StudAtten.this);
		        	
		       }
			      
    			         else 			Toast.makeText(StudAtten.this, "Date empty!!!", Toast.LENGTH_SHORT).show();
      	...
      	{
    			e.printStackTrace();
		      		Toast.makeText(StudAtten.this, e.getMessage(), Toast.LENGTH_SHORT).show();
...
*/
		...
		protected void setlist() {
		        ...
		        dialogReg = new Dialog(StudAtten.this);
		   ...
		   private void viewall() {
			   ...
			   final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(StudAtten.this, android.R.layout.simple_list_item_checked, categories_code);
