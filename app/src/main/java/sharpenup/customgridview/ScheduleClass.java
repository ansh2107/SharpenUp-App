...
//	int flag,flag_btn_click;
		...
		public void onClick(View v) {
			...
			if (checkerForSubmission()){
				 ...
				 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
					...
					AlertDialog.Builder builder = new AlertDialog.Builder(ScheduleClass.this);
					builder.setMessage("Are you sure you want to schedule this class?").setPositiveButton("Yes", dialogClickListener)
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(ScheduleClass.this);
      ...
      try {
			...
			Toast.makeText(ScheduleClass.this, "Data Modified", Toast.LENGTH_SHORT).show();
			else
				Toast.makeText(ScheduleClass.this, "Successfully scheduled.", Toast.LENGTH_SHORT).show();
		} catch (Exception e) 
  	{
			e.printStackTrace();
			Toast.makeText(ScheduleClass.this, "Internet connection error!!!", Toast.LENGTH_SHORT).show();
		} 
