...
import sharpenup.previous.sharpenup.delete;

import sharpenup.customgridview.R;
import sharpenup.previous.sharpenup.BackgroundContainer;
import sharpenup.previous.sharpenup.StableArrayAdapter;
...
public class delete extends Activity  {
 ...
 Button add =(Button)findViewById(R.id.add);
    ...
    private class addNew extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(delete.this);
