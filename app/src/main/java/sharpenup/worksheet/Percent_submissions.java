...
public class Percent_submissions extends Activity{
	...
	sub.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			 DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(Percent_submissions.this);
				builder.setMessage("Are you sure you want to view percentage?").setPositiveButton("Yes", dialogClickListener)
 ...
 ArrayAdapter<String> dataAdapter_top1 = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, categories_topics );
   ...
   dataAdapter_top1.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private class time extends AsyncTask<String, Void, String> {
    	JSONObject json;
    	private ProgressDialog dialog = new ProgressDialog(Percent_submissions.this);
	...
	catch (JSONException e) 
	{
      ...
      Percent_submissions.this.recreate();
  		...
  		categories_code.clear();
			...
			//Toast.makeText(MainActivity.this, (CharSequence) json, 1).show();
				 ...
				 JSONArray account= json.getJSONArray("pendings");
			        ...
			        {
			        	json =account.getJSONObject(i);
			        	String smtd =json.getString("STUDENTS");
			        	String cmptd=json.getString("SUBMITTED");
			        	String ncmptd=json.getString("NOTSUBMITTED");
			       ...
			       Toast.makeText(Percent_submissions.this, "total:"+total+"Completed:"+comp+"notcompleted:"+notcomp, 1).show();
	 ...
	 private void showDate0(int year, String month, String day) {
		...
		//-----------------------------------------------------------------------------------------------
		   ...
		   protected void setlist() {
		        ...
		        dialogReg = new Dialog(Percent_submissions.this);
		   ...
		   private void viewall() {
			   ...
			   ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Percent_submissions.this, android.R.layout.simple_list_item_checked, categories_code);
