...
public class TeacherCheck extends Activity {
 ...
 new studentsview().execute();
    ...
    private class time extends AsyncTask<String, Void, String> {
    	...
    	private ProgressDialog dialog = new ProgressDialog(TeacherCheck.this);
        ...
        protected String doInBackground(String... urls) 
        {
			...
			params.add(new BasicNameValuePair("completed", submitted));
			params.add(new BasicNameValuePair("notcompleted", notSubmitted));
			//params.add(new BasicNameValuePair("leave", leave));
			 String url = "http://176.32.230.250/anshuli.com/sharpenup3/setCompletionStatus.php";
	 ...
	 private class studentsview extends AsyncTask<String, Void, String> {
	    ...
	    //JSONArray jsonArray;
				...
				//Toast.makeText(MainActivity.this, (CharSequence) json, 1).show();
					 ...
					 JSONArray account= json.getJSONArray("pendings");
				        for(int i = 0; i < account.length(); i++)
				        {
				        	...
				        	String students=json.getString("SUBMITTED");
				        	...
				        	String	NOTCOMPLETED=json.getString("NOTCOMPLETED");
				        	String flag="";
				        	if(COMPLETED.equals("")&&NOTCOMPLETED.equals("")){
				        		flag="Completion report due";
	     ...
	     ArrayAdapter<String>	dataAdapter = new ArrayAdapter<String>(TeacherCheck.this, android.R.layout.simple_list_item_1, ultimate);
	   ...
	   protected void setlist(List<String> dsip_Students) {
	        ...
	        dialogReg = new Dialog(TeacherCheck.this);
	        ...
	        b1= (Button)dialogReg.findViewById(R.id.button1);
	         ...
	         b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					TeacherCheck.this.recreate();	// TODO Auto-generated method stub
					dialogReg.dismiss();
				}
			});
	   ...
	   private void triggerNotification() {
		   ...
		   Intent notificationIntent = new Intent(this, TeacherCheck.class);
